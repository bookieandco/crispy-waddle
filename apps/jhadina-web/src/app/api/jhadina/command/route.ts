 ...
 *
 * This is a thin HTTP adapter. The acting user is established exclusively
 * from the server-verified Supabase session; the browser cannot select an
 * actor with x-jhadina-user-id or a default identity.
 */
