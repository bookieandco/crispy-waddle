...
export function validateOpportunity(opportunity: Opportunity): OpportunityValidationResult {
  ...
  if (opportunity.verificationStatus === 'verified' && !isCompleteVerification(opportunity.verificationDecision, opportunity.id)) {
    issues.push({
  ...
  if (opportunity.status === 'ready' && opportunity.family === 'recovery' && !isCompleteVerification(opportunity.verificationDecision, opportunity.id)) {
    issues.push({
