...
--
-- Extends canonical storyboard heads and append-only board history so downstream
-- generation/QC can reconstruct the exact authored direction used for a board version.
