...
function buildSystemPrompt(): string {
  return [
    ...
    'deliberatePauses are presentation targets only. They never authorize tool use,',
    'execution, persistence, skipping approval, changing factual conclusions, or',
    'relaxing evidence requirements. symbolicFraming="interpretive" permits metaphor',
