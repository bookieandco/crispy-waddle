...
/**
 * PL-7 live-run verification: a SEPARATE config from vitest.config.ts
 ...
 * pl7-live-stripe-verification.live.ts — which makes real calls
 * against Stripe's test API. The only thing that ever points at this
 * config is .github/workflows/pl7-live-stripe-verification.yml, a
...
export default defineConfig({
  ...
  test: {
    include: ["src/lib/commerce/pl7-live-stripe-verification.live.ts"],
    testTimeout: 30_000,
    hookTimeout: 30_000,
  },
})
