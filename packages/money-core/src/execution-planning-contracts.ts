...
export type ExecutionMarketSnapshot=Readonly<{snapshotId:string;instrumentId:string;currency:string;bidMinor:bigint;askMinor:bigint;bidSize:string;askSize:string;observedAt:string;availableAt:string;expiresAt:string;evidenceIds:readonly string[];provenanceHash:string}>
