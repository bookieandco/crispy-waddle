...
const worldRows: [JhadinaWorldId, string, string, string[], string[]][] = [
...
export const JHADINA_WORLDS: JhadinaWorldDefinition[] = worldRows.map(([id, label, description, capabilities, inputs]) => ({
  id,
  label,
  description,
