...
function productionCapabilities(...capabilities: DirectorProductionCapability[]): readonly DirectorProductionCapability[] {
...
export const DIRECTOR_VIDEO_PROFILES: Readonly<Record<DirectorVideoFormat, VideoProductionProfile>> = Object.freeze({
  'long-form': Object.freeze({
    ...
    format: 'long-form',
    requiredCapabilities: productionCapabilities(
