...
const plan={opportunityId:'o',structure:'prime_with_subcontractor',assignments:[{providerId:'p',role:'subcontractor',requirementIds:['r'],evidenceRefs:['e'],score:90}],coveredRequirementIds:['r'],uncoveredRequirementIds:[],blockers:[],rationale:[],requiresHumanApproval:true,engagementAuthorized:false} as const
const packet={id:'pkt',opportunityId:'o',providerId:'p',role:'subcontractor',requirementIds:['r'],evidenceRefs:['e'],subject:'Quote',draftBody:'Quote?',diligenceQuestions:[],negotiationPoints:[],commercialSummary:{structure:'prime_with_subcontractor',modeledGrossRevenue:100,modeledMarginPercent:20},approvalRef:'a',draftOnly:true,sendAuthorized:false,contractAuthorized:false} as const
