...
export default function Home() {
  ...
  const exceptionText=activityError?activityError:activityLoading?'Checking governed activity…':state.exceptions.length?state.exceptions.length+' failed or denied Growth event'+(state.exceptions.length===1?'':'s')+' in the current ledger.':'No failed or denied Growth events in the current ledger. This is not a whole-system health claim.';
