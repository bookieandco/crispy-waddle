...
export const STOCK_VISION_DATASETS:Readonly<Record<StockVisionDatasetId,StockVisionDatasetDescriptor>>=Object.freeze({
  'roboflow:mod5gen20-cnkzt/stocks-2ulc2':Object.freeze({
    ...
    normalizedPatterns:Object.freeze<StockChartPattern[]>(['TRIANGLE','HEAD_AND_SHOULDERS_BOTTOM','HEAD_AND_SHOULDERS_TOP','M_HEAD','STOCK_LINE','W_BOTTOM']),
    authority:'REFERENCE_ONLY',
    canAuthorizeLive:false,
  }),
  'roboflow:glitch-gyhbu/shitty-stocks-patterns':Object.freeze({
    ...
    normalizedPatterns:Object.freeze<StockChartPattern[]>(['BEARISH_ENGULFING','EVENING_STAR','INSIDE_BAR','LONG_WICKS','SHOOTING_STAR']),
