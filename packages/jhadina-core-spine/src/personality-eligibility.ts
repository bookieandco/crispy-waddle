...
export const DEFAULT_PERSONALITY_ELIGIBILITY_RULES: readonly PersonalityEligibilityRule[] = [{
  ...
  ruleId: 'communication-warmth-v1',
  patternIdPrefix: 'personality-signal:communication:warmth',
  dimension: 'communication',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'communication-formality-v1',
  patternIdPrefix: 'personality-signal:communication:formality',
  dimension: 'communication',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'humor-enabled-v1',
  patternIdPrefix: 'personality-signal:humor:enabled',
  dimension: 'humor',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'communication-profanity-v1',
  patternIdPrefix: 'personality-signal:communication:profanity',
  dimension: 'communication',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'communication-pushback-v1',
  patternIdPrefix: 'personality-signal:communication:pushback',
  dimension: 'communication',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'communication-technical-depth-v1',
  patternIdPrefix: 'personality-signal:communication:technical-depth',
  dimension: 'communication',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'preference-continuous-workflow-v1',
  patternIdPrefix: 'personality-signal:preference:continuous-workflow',
  ...
  ruleId: 'communication-step-by-step-v1',
  patternIdPrefix: 'personality-signal:communication:step-by-step',
  dimension: 'communication',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'communication-evidence-first-v1',
  patternIdPrefix: 'personality-signal:communication:evidence-first',
  dimension: 'communication',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'preference-multiple-options-v1',
  patternIdPrefix: 'personality-signal:preference:multiple-options',
  dimension: 'preference',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'taste-experimentation-v1',
  patternIdPrefix: 'personality-signal:taste:experimentation',
  dimension: 'taste',
  minimumObservations: 3,
  minimumEvidence: 3,
  maximumContradictions: 3,
  ...
  ruleId: 'relationship-familiar-tone-v1',
  patternIdPrefix: 'personality-signal:relationship:familiar-tone',
