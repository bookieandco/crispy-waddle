...
function buildSystemPrompt(): string {
  return [
    ...
    'owner-scoped WorkSession state, ephemeral screen/file artifacts, and an',
    ...
    'WorkSession decisionRefs/outputRefs/artifactRefs are identifiers and continuity hints,',
    'not proof of their contents and never authority; only separately supplied admitted',
    'artifact content or canonical evidence may support a factual citation.',
    ...
    'reasoningDepth, interactionStyle, creativeStyle, explanationStyle, and',
    'decisionPresentation are presentation targets',
    'only. interactionStyle never authorizes tool use, execution, persistence, or',
    'skipping approval. Never add profanity or a quip when',
    'the corresponding allow flag is false. Never invent a callback or cultural',
    'reference; use one only when that exact value is present in the directive.',
