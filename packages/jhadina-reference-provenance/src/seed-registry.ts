...
const tracedReferences: readonly RegisterReferenceInput[] = [
  {
    ...
    licenseEvidenceLocator: 'https://github.com/godotengine/godot/blob/57277407e77e61b161f35dbd7aeb510f7a9e26a6/LICENSE.txt',
    notes:
  ...
  },
  {
    ...
    kind: 'GITHUB_REPOSITORY',
    roles: ['UI_REFERENCE', 'INSPIRATION'],
    canonicalLocator: 'https://github.com/turbulenz/turbulenz_engine',
    sourceRevision: '403ef0dadbe93aac3122928441cc0cb8b075b1cf',
    discoveredFrom: 'REPOSITORY',
    traceabilityStatus: 'REPO_TRACEABLE',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'MIT',
    licenseEvidenceLocator: 'https://github.com/turbulenz/turbulenz_engine/blob/403ef0dadbe93aac3122928441cc0cb8b075b1cf/LICENSE',
    notes:
      'Explicitly named as an inspiration/reference in the PupsonStuff engine plan. No code-derivation claim is made.',
    evidence: [
      {
...
const handoffOnlyReferences: readonly RegisterReferenceInput[] = [
  {
    ...
    canonicalLocator: 'https://github.com/maariia-saez/MDP-Adaptive-GA',
    sourceRevision: '1f4ff9a461e37b7b7bd36223554bca3213ea9474',
    discoveredFrom: 'HANDOFF',
    traceabilityStatus: 'HANDOFF_ONLY',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'MIT',
    licenseEvidenceLocator: 'https://github.com/maariia-saez/MDP-Adaptive-GA/blob/1f4ff9a461e37b7b7bd36223554bca3213ea9474/LICENSE',
    notes:
  ...
  },
  {
    ...
    licenseEvidenceLocator: 'https://github.com/yinzhangyue/SelfAware/blob/f0bad1ff77bd42fc4eb2360281ed646c7bb7bd0c/LICENSE',
    notes:
      'Named in sports handoff history; not traceable on current crispy-waddle main at REF-PROV-01 audit time.',
    evidence: [
      {
  ...
  },
  {
    ...
    kind: 'GITHUB_REPOSITORY',
    roles: ['ALGORITHM_REFERENCE'],
    canonicalLocator: 'https://github.com/RC-Dynamics/Coach-RL',
  ...
  },
  {
    ...
    canonicalLocator: 'https://github.com/Verified-Intelligence/alpha-beta-CROWN',
  ...
  },
  {
    ...
    canonicalLocator: 'https://github.com/pump-fun/pump-public-docs',
  ...
  },
  {
    ...
    kind: 'GITHUB_REPOSITORY',
    roles: ['ALGORITHM_REFERENCE', 'SECURITY_REFERENCE'],
    canonicalLocator: 'https://github.com/keidev-sol/Meteora-Rug-Bot',
  ...
  },
  {
    ...
    kind: 'GITHUB_REPOSITORY',
    roles: ['ALGORITHM_REFERENCE'],
    canonicalLocator: 'https://github.com/baronguyen001/wallet-cluster-detector',
    sourceRevision: 'e4b6d75c75ffa3d40f61f974998b097128957355',
    discoveredFrom: 'HANDOFF',
    traceabilityStatus: 'HANDOFF_ONLY',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'MIT',
    licenseEvidenceLocator: 'https://github.com/baronguyen001/wallet-cluster-detector/blob/e4b6d75c75ffa3d40f61f974998b097128957355/LICENSE',
    notes:
  ...
  },
  {
    ...
    kind: 'GITHUB_REPOSITORY',
    roles: ['ARCHITECTURE_REFERENCE'],
    canonicalLocator: 'https://github.com/assafelovic/gpt-researcher',
    sourceRevision: '6f998577d547b1e54ec662dac63583aa11e3b84b',
    discoveredFrom: 'HANDOFF',
    traceabilityStatus: 'HANDOFF_ONLY',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'Apache-2.0',
    licenseEvidenceLocator: 'https://github.com/assafelovic/gpt-researcher/blob/6f998577d547b1e54ec662dac63583aa11e3b84b/LICENSE',
    notes:
  ...
  },
  {
    ...
    kind: 'GITHUB_REPOSITORY',
    roles: ['ARCHITECTURE_REFERENCE'],
    canonicalLocator: 'https://github.com/dzhng/deep-research',
    sourceRevision: '1f8f3e285bbc23e80b98a66a64effab9069f3ad4',
    discoveredFrom: 'HANDOFF',
    traceabilityStatus: 'HANDOFF_ONLY',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'MIT',
    licenseEvidenceLocator: 'https://github.com/dzhng/deep-research/blob/1f8f3e285bbc23e80b98a66a64effab9069f3ad4/LICENSE',
    notes:
      'Named in Knowledge/research handoff history; not traceable on current main.',
    evidence: [
      {
  ...
  },
  {
    ...
    canonicalLocator: 'https://github.com/XecureLogic/policy-gate',
    sourceRevision: 'a1fae85a6294098b0deed51c1c50ecf3000ec41f',
    discoveredFrom: 'HANDOFF',
    traceabilityStatus: 'HANDOFF_ONLY',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'Apache-2.0',
    licenseEvidenceLocator: 'https://github.com/XecureLogic/policy-gate/blob/a1fae85a6294098b0deed51c1c50ecf3000ec41f/LICENSE',
    notes:
...
const repositoryWideReferences: readonly RegisterReferenceInput[] = [
  ...
  },
  {
    ...
    kind: 'LIBRARY',
    roles: ['API_PROVIDER', 'ARCHITECTURE_REFERENCE'],
    canonicalLocator: 'https://github.com/markqvist/Reticulum',
  ...
  },
  {
    ...
    kind: 'LIBRARY',
    roles: ['API_PROVIDER', 'MODEL_REFERENCE'],
    canonicalLocator: 'https://github.com/Comfy-Org/ComfyUI',
    sourceRevision: 'c8ed2c8ce957475459731135c4ca31c6856a4542',
    discoveredFrom: 'REPOSITORY',
    traceabilityStatus: 'REPO_TRACEABLE',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'GPL-3.0',
    licenseEvidenceLocator: 'https://github.com/Comfy-Org/ComfyUI/blob/c8ed2c8ce957475459731135c4ca31c6856a4542/LICENSE',
  ...
  },
  {
    ...
    kind: 'LIBRARY',
    roles: ['API_PROVIDER', 'DATA_SOURCE'],
    canonicalLocator: 'https://github.com/supabase/supabase',
    sourceRevision: '2a75ff7ae6e0059b34f2c242febd2916d17fc5de',
    discoveredFrom: 'REPOSITORY',
    traceabilityStatus: 'REPO_TRACEABLE',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'Apache-2.0',
    licenseEvidenceLocator: 'https://github.com/supabase/supabase/blob/2a75ff7ae6e0059b34f2c242febd2916d17fc5de/LICENSE',
  ...
  },
  {
    ...
    canonicalLocator: 'https://github.com/facebookresearch/sam2',
    sourceRevision: '2b90b9f5ceec907a1c18123530e92e794ad901a4',
    discoveredFrom: 'REPOSITORY',
    traceabilityStatus: 'REPO_TRACEABLE',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'Apache-2.0',
    licenseEvidenceLocator: 'https://github.com/facebookresearch/sam2/blob/2b90b9f5ceec907a1c18123530e92e794ad901a4/LICENSE',
  ...
  },
  {
    ...
    kind: 'MODEL',
    roles: ['MODEL_REFERENCE'],
    canonicalLocator: 'https://github.com/haoheliu/voicefixer',
    sourceRevision: 'aae2253c85f97a87b844b6832384de249c23ab37',
    discoveredFrom: 'REPOSITORY',
    traceabilityStatus: 'REPO_TRACEABLE',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'MIT',
    licenseEvidenceLocator: 'https://github.com/haoheliu/voicefixer/blob/aae2253c85f97a87b844b6832384de249c23ab37/LICENSE',
  ...
  },
  {
    ...
    kind: 'MODEL',
    roles: ['MODEL_REFERENCE'],
    canonicalLocator: 'https://github.com/DamRsn/NeuralNote',
    sourceRevision: '20ca45ad7b4429dea05a9321020b62bf2ff32fae',
    discoveredFrom: 'REPOSITORY',
    traceabilityStatus: 'REPO_TRACEABLE',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'Apache-2.0',
    licenseEvidenceLocator: 'https://github.com/DamRsn/NeuralNote/blob/20ca45ad7b4429dea05a9321020b62bf2ff32fae/LICENSE',
  ...
  },
  {
    ...
    canonicalLocator: 'https://github.com/jatinchowdhury18/AnalogTapeModel',
    sourceRevision: '604372e4ffd9690c3e283362e4598cb43edbb475',
    discoveredFrom: 'REPOSITORY',
    traceabilityStatus: 'REPO_TRACEABLE',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'GPL-3.0',
    licenseEvidenceLocator: 'https://github.com/jatinchowdhury18/AnalogTapeModel/blob/604372e4ffd9690c3e283362e4598cb43edbb475/LICENSE',
  ...
  },
  {
    ...
    kind: 'LIBRARY',
    roles: ['ARCHITECTURE_REFERENCE'],
    canonicalLocator: 'https://github.com/DBraun/DawDreamer',
    sourceRevision: '727469f1317e96d0acee80d19fd57aeb0dbd0948',
    discoveredFrom: 'REPOSITORY',
    traceabilityStatus: 'REPO_TRACEABLE',
    licenseStatus: 'VERIFIED',
    licenseExpression: 'GPL-3.0',
    licenseEvidenceLocator: 'https://github.com/DBraun/DawDreamer/blob/727469f1317e96d0acee80d19fd57aeb0dbd0948/LICENSE',
  ...
  },
  {
    ...
    kind: 'LIBRARY',
    roles: ['ARCHITECTURE_REFERENCE'],
    canonicalLocator: 'https://github.com/FFmpeg/FFmpeg',
  ...
  },
  {
    ...
    kind: 'LIBRARY',
    roles: ['ARCHITECTURE_REFERENCE'],
    canonicalLocator: 'https://github.com/musescore/MuseScore',
    sourceRevision: '2b540fe37ae7009b06b79301f233c9c2db6b651c',
    discoveredFrom: 'REPOSITORY',
    traceabilityStatus: 'REPO_TRACEABLE',
    licenseStatus: 'UNKNOWN',
