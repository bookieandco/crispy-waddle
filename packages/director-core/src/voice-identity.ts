...
export const DIRECTOR_VOICE_PROVIDER_PROFILES: readonly VoiceProviderProfile[] = Object.freeze([
  Object.freeze({
    ...
    name: 'Qwen3-TTS',
    license: 'Apache-2.0',
    capabilities: Object.freeze(['voice-clone','voice-design','multilingual','streaming','style-control'] as const),
    languageCount: 10,
  ...
  Object.freeze({
    ...
    name: 'VoxCPM2',
    license: 'Apache-2.0',
    capabilities: Object.freeze(['voice-clone','voice-design','multilingual','streaming','style-control','word-timestamps'] as const),
    languageCount: 30,
  ...
  Object.freeze({
    ...
    name: 'Voicebox',
    license: 'MIT',
    capabilities: Object.freeze(['voice-clone','voice-design','multilingual','style-control'] as const),
    languageCount: 23,
  ...
  Object.freeze({
    ...
    capabilities: Object.freeze(['voice-clone','multilingual','accent-conversion','singing','speaker-similarity-qc'] as const),
  ...
  Object.freeze({
    ...
    name: 'Voice-Pro',
    license: 'GPL-3.0',
    capabilities: Object.freeze(['voice-clone','multilingual'] as const),
