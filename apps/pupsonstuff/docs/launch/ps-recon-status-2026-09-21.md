...
Create/link a dedicated Vercel project with root directory `apps/pupsonstuff`, Node 22+, preview/production environments, canonical HTTPS origin, and the five-minute creative-worker cron.
