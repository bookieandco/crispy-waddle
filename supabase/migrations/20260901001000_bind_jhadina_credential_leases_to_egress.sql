-- Bind durable credential leases to the exact egress authorization that caused them to be issued.
-- This migration is additive so existing leases remain structurally readable, but
-- new governed releases can require the binding at the application boundary.
