...
| Roboflow `MOD5GEN20/stocks-2ulc2` | Verified Universe dataset page; 6,572 object-detection images, CC BY 4.0, chart-pattern labels | CAPTURED / research-training reference |
